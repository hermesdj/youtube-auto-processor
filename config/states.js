...
module.exports = (function () {
  const states = {
    ...
    VIDEO_READY: {
      ...
      label: 'VIDEO_READY',
      next: function () {
        return states.VIDEO_PROCESSING;
      }
    },
    VIDEO_DONE: {
      id: 4,
    ...
    UPLOAD_READY: {
      ...
      label: 'UPLOAD_READY',
      next: function () {
        return states.UPLOAD_PROCESSING;
      }
    },
    UPLOAD_DONE: {
      id: 7,
      label: 'UPLOAD_DONE',
      next: function () {
        return states.SET_VIDEO_DATA;
      }
    },
    SET_VIDEO_DATA: {
      id: 8,
      label: 'SET_VIDEO_DATA',
      next: function () {
    ...
    UPLOAD_PROCESSING: {
      id: -4,
      label: 'UPLOAD_PROCESSING',
      next: function () {
        return states.UPLOAD_DONE
      }
    }
  };
