...
module.exports = function (/* ctx */) {
  return {
    ...
    pwa: {
      ...
      manifest: {
        name: `Youtube Auto Processor Quasar App`,
        short_name: `Youtube Auto Processor Quasar App`,
        description: `A new GUI for the Youtube Auto Processor based on Quasar Framework`,
        display: 'standalone',
